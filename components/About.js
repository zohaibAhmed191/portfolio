          ...
          <div className="row gap-100 align-items-center">
              ...
              <div className="about-content-part rel z-2 rmb-55">
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <p>
                    ...
                    I transform complex ideas into functional, visually
                    appealing solutions. My focus is on delivering exceptional
                    results that drive innovation and exceed expectations.
                  </p>
                </div>
            ...
            <div className="col-lg-5">
              <div className="about-image-part wow fadeInUp delay-0-3s">
                <img src="assets/images/hero/new-me.png" alt="About Me" />
                <div className="about-btn btn-one wow fadeInRight delay-0-4s">
                  <img src="assets/images/about/btn-image1.png" alt="Image" />
                  <h6>Web App Developer</h6>
