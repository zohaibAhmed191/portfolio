...
const counterData = [
  ...
  { id: 2, text: "Project Complete", value: "100", valueType: "plus" },
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              ...
              <h1>
                <b>Zohaib Ahmed</b> WEB APP Developer
              </h1>
              <p>
                dedicated to crafting seamless,
                innovative, and user-focused digital experiences that bring
                ideas to life.
              </p>
          ...
          <div className="col-lg-5">
            <div className="author-image-part wow fadeIn delay-0-3s">
              ...
              <img src="assets/images/hero/new-me.png" alt="Author" />
